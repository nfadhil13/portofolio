...
export const Hero = () => {
  return (
    <section className="min-h-[60vh] flex flex-col justify-center items-center text-center p-6 bg-gradient-to-b from-primary to-primary/90 text-white animate-fadeIn">
